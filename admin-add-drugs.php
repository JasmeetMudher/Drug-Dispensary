...
<?php
    ...
    if(isset($_POST["btn-add-drug"])) {
        ...
        */
        ...
        if($crud->create('drugs',$drug_data)){
            $msg ="success";
            ...
            $db = mysqli_connect("localhost", "stonie", "123pass", "geeksforgeeks");
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
                ...
                <a class="nav-link " href="/admin-add-drugs.php">
                    <i class="bi bi-grid"></i>
                    <span>Add Drugs</span>
                </a>
                <a class="nav-link " href="/admin-view-drugs.php">
                    <i class="bi bi-grid"></i>
